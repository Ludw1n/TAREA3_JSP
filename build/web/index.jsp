...
<script type="text/javascript">
    ...
    $('#tbl_empleados').on('click','tr td',function(event){
     ...
     id = target.parent().data('id');
      ...
      codigo= target.parent("tr").find("td").eq(0).htm();
      nombres= target.parent("tr").find("td").eq(1).htm();
      apellidos= target.parent("tr").find("td").eq(2).htm();
      direccion= target.parent("tr").find("td").eq(3).htm();
      telefono= target.parent("tr").find("td").eq(4).htm();
      nacimiento= target.parent("tr").find("td").eq(0).htm();
